...
export const translations = {
  en: {
    ...
    resume: 'resume',
    resumeFromHere: 'Resume the migration from this step',
    resumeTitle: 'Resume from this step?',
    resumeBody: 'The migration will be reset to the state BEFORE:',
    resumeWarn: 'This runs git reset --hard on the destination, discarding the commits AFTER this step, and re-runs from here.',
    resumeConfirm: 'Reset & resume',
    resumeFailed: 'Failed to resume migration.',
    cancel: 'Cancel',
  ...
  pt: {
    ...
    resume: 'retomar',
    resumeFromHere: 'Retomar a migração a partir deste step',
    resumeTitle: 'Retomar a partir deste step?',
    resumeBody: 'A migração será resetada para o estado ANTES de:',
    resumeWarn: 'Isso roda git reset --hard no destino, descartando os commits POSTERIORES a este step, e re-roda a partir daqui.',
    resumeConfirm: 'Resetar e retomar',
    resumeFailed: 'Falha ao retomar a migração.',
    cancel: 'Cancelar',
