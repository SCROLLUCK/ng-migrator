...
export const translations = {
  en: {
    ...
    inPlaceHint: 'Needs a clean git tree; runs on a dedicated branch',
    branchName: 'Migration branch name',
    ...
    correctionsTitle: 'Corrections applied',
    correctionsSubtitle: 'Library-specific fixes applied during migration (runtime-safe, not just neutralized).',
    correctionsLibrary: 'Corrections library',
    correctionsLibraryHint: 'Available corrections (auto-discovered). Upload a .mjs file to add your own.',
    uploadCorrection: 'Upload correction',
    uploadFailed: 'Upload failed',
    correctionsUnavailable: 'Endpoint unavailable — the running server predates this feature. Restart the dashboard (npm run ui) after the migration finishes.',
    refresh: 'Refresh',
    knownErrorsTitle: 'Known errors',
    knownErrorsButton: 'glossary',
    warningsHint: "Warnings don't block the build (e.g. NG8113 unused imports). Pruned at the cleanup step.",
    knownErrorsFilter: 'Filter by code, title or description…',
    knownErrorsPresent: 'present',
    knownErrorsUndocumented: 'Present but not documented',
    knownErrorsNoMatch: 'No matching error code.',
    stepActions: 'actions',
  ...
  pt: {
    ...
    inPlaceHint: 'Exige git limpo; roda numa branch dedicada',
    branchName: 'Nome da branch de migração',
    ...
    correctionsTitle: 'Correções aplicadas',
    correctionsSubtitle: 'Fixes específicos de lib aplicados na migração (runtime-safe, não apenas neutralizados).',
    correctionsLibrary: 'Biblioteca de correções',
    correctionsLibraryHint: 'Correções disponíveis (auto-descobertas). Envie um arquivo .mjs para adicionar a sua.',
    uploadCorrection: 'Enviar correção',
    uploadFailed: 'Falha no envio',
    correctionsUnavailable: 'Endpoint indisponível — o servidor em execução é anterior a esta feature. Reinicie o dashboard (npm run ui) após a migração terminar.',
    refresh: 'Atualizar',
    knownErrorsTitle: 'Erros conhecidos',
    knownErrorsButton: 'glossário',
    warningsHint: 'Warnings não bloqueiam o build (ex: NG8113 imports não-usados). Removidos no step de cleanup.',
    knownErrorsFilter: 'Filtrar por código, título ou descrição…',
    knownErrorsPresent: 'presente',
    knownErrorsUndocumented: 'Presentes mas não documentados',
    knownErrorsNoMatch: 'Nenhum código de erro corresponde.',
    stepActions: 'ações',
