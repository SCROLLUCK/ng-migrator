...
export const translations = {
  en: {
    ...
    resumeOptionDesc: 'Resets to the state BEFORE this step and re-runs the migration from here. Use after fixing the migrator.',
    rollbackOption: 'Roll back to this state (stop)',
    rollbackOptionDesc: 'Restores the project to the state right AFTER this step + reinstalls deps, and stops. Recovers a point that built cleanly.',
  ...
  pt: {
    ...
    resumeOptionDesc: 'Reseta para o estado ANTES deste step e re-roda a migração a partir daqui. Use depois de corrigir o migrador.',
    rollbackOption: 'Voltar pra este estado (para)',
    rollbackOptionDesc: 'Restaura o projeto para o estado logo APÓS este step + reinstala as deps, e para. Recupera um ponto que buildava limpo.',
